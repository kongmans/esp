...
#define wifi_name  "布凡"     //WIFI名称，区分大小写，不要写错
#define wifi_password   "20202020"  //WIFI密码
String UID = "9b6d3f9823f74f90ac83c424cf8ae2b1";  //用户私钥，可在控制台获取,修改为自己的UID
String TOPIC = "light002";         //主题名字，可在控制台新建
const int LED_Pin = D4;              //单片机LED引脚值，D2是NodeMcu引脚命名方式，其他esp8266型号将D2改为自己的引脚                         
String upUrl = "http://bin.bemfa.com/b/3BcOWI2ZDNmOTgyM2Y3NGY5MGFjODNjNDI0Y2Y4YWUyYjE=light002.bin";//固件链接，在巴法云控制台复制、粘贴到这里即可
